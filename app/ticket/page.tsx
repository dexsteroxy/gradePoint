  ...
  return (
    <div className="bg-black-100 md:pb-32 min-h-screen">
      ...
      <div className="pt-32 px-4 z-30 ">
        ...
        <p className="mt-6 beans md:mt-12 bg-black-200 md:bg-transparent z-50 p-2 leading-8 md:px-4 text-gray-200 md:text-center font-medium md:max-w-[200x]">
          "The <span className="text-purple">Result (GP)</span> Tracker
          offers a comprehensive solution for efficient result tracking.
          Simply provide your data, and our system will handle the rest,
          ensuring accurate and reliable monitoring of your academic
          performance."
        </p>
          ...
          <div className="flex flex-col -ml-8 md:-ml-0 md:flex-row items-start justify-between gap-x-6 container mx-auto">
            <div className="md:w-[50%] flex tochi mt-12 flex-col">
              ...
              <div
                ...
                className="lg:w-[550px] md:w-[500px] z-30 mb-4 xl:w-[620px] w-[288px] cursor-pointer flex items-center h-12 bg-black-200 rounded-md border-[1px] border-gray-600"
              >
              ...
              {question1 && (
                <div className="bg-black-200 md:w-[500px] border-[1px] z-30 -mt-4 mb-4 rounded-md border-gray-600 xl:w-[620px] h-fit p-6 lg:w-[550px]">
                  <p>
                    ...
                    Ipsa, ipsum alias labore non consequatur dolor quidem odio
                    cupiditate libero nobis!
                  </p>
                </div>
              )}
              ...
              <div
                ...
                className="lg:w-[550px] md:w-[500px] z-30 mb-4 xl:w-[620px] cursor-pointer flex items-center w-full h-12 bg-black-200 rounded-md border-[1px] border-gray-600"
              >
                <p className="items-center flex md:text-xl text-[16px] tracking-tight pl-6 text-gray-200 font-bold">
              ...
              >
                <p className="items-center flex md:text-xl text-[16px] tracking-tight pl-6 text-gray-200 font-bold">
                  Can I track multiple results at once?
                </p>
              </div>
              {/* reply */}
              {question3 && (
