...
//             <LabelInputContainer className="mb-4">
//               <Label htmlFor="email">Your department</Label>
//               <input
//                 id="email"
//                 value={department}
//                 type="email"
...
//                 <span className="animate-spin text-green-600 text-4xl mt-2">
//                   <LuLoader />
//                 </span>
//               </div>
//             )}
      ...
      <div className="mx-2 md:mx-0 overflow-clip mt-20 md:mt-32 mb-4 shadow-md shadow-slate-500 sm:shadow-transparent">
        <div className="max-w-md md:max-w-lg w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-6 shadow-slate-500 shadow-lg bg-white dark:bg-black-200">
          ...
          <form onSubmit={handleRegistration}>
            ...
            <button
              className="bg-gradient-to-br relative group/btn from-black dark:from-zinc-900 dark:to-zinc-900 to-neutral-600 justify-center dark:bg-zinc-800 w-full text-white rounded-md h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] transition-all hover:shadow-none"
              type="submit"
              disabled={loading}
            >
              {loading ? (
