...
//         <div className="max-w-md md:max-w-lg w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-6 shadow-slate-500 shadow-md py-20 md:py-2 bg-black-200">
//           <h2 className="font-bold text-xl mb-4 text-center">Welcome</h2>
//           <form onSubmit={handleSubmit}>
//             <div className="flex flex-col space-y-6 md:space-y-2 mb-4">
//               <LabelInputContainer>
...
import { addCalculation } from "@/redux/slices/calculationSlice";
...
export const Save: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Save the form data to context
    const formData = { level, semester, year };
    saveFormData(formData);

    // Dispatch addCalculation action
    dispatch(addCalculation({
      ...formData,
      gradePoint: '', // Set initial gradePoint if needed
      calculationDetails: [], // Set initial calculationDetails if needed
    }));
