...
//             </>
//           ) : (
//             <div className="bg-black-200 py-32 md:py-12 items-center container justify-center shadow-lg shadow-gray-500 rounded-lg flex flex-col md:h-fit md:p-12 p-2">
//               <TextGenerateEffect
//                 words="Welcome User"
...
import { motion } from "framer-motion";
import { useDispatch } from 'react-redux';
import { addCalculation } from '@/redux/slices/calculationSlice'; // Updated import
...
const Result: React.FC = () => {
  ...
  const calculateGradePoint = () => {
    ...
    // Dispatch the grade point and details to the Redux store
    dispatch(addCalculation({ gradePoint: gp, calculationDetails: details })); // Updated action
  };
