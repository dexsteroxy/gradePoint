    ...
    justify-center 
      ...
      >
        <div className=" mt-20">
          ...
          <p className=" mt-6 md:mt-12 leading-8 px-4 text-gray-200 text-justify md:text-center font-medium md:max-w-[670px] ">
            "The Result (GP) Tracker offers a comprehensive solution for
